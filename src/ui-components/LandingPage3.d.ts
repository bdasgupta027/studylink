...
export declare type LandingPage3OverridesProps = {
    LandingPage3?: PrimitiveOverrideProps<FlexProps>;
...
export declare type LandingPage3Props = React.PropsWithChildren<Partial<FlexProps> & {
    colorMode?: "Default";
} & {
    overrides?: LandingPage3OverridesProps | undefined | null;
}>;
export default function LandingPage3(props: LandingPage3Props): React.ReactElement;
