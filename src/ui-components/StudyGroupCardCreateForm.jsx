...
export default function StudyGroupCardCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAcceptingMembers(initialValues.acceptingMembers);
    setGroupOwner(initialValues.groupOwner);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createStudyGroupCard.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "StudyGroupCardCreateForm")}
      {...rest}
    >
      <TextField
        label={
