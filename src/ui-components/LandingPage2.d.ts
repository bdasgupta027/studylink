...
export declare type LandingPage2OverridesProps = {
    LandingPage2?: PrimitiveOverrideProps<FlexProps>;
...
export declare type LandingPage2Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: LandingPage2OverridesProps | undefined | null;
}>;
export default function LandingPage2(props: LandingPage2Props): React.ReactElement;
